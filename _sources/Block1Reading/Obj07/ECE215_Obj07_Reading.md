...
**Note**: power conversion work-out problems will be covered in class time. This reading details how power conversion works. See the Objective 7 [lecture slides](book\_static\B1_Obj07_Converters_Slides.pdf) and [practice problems](book\_static\PPs\ECE215_PP09.pdf) for examples of work-out problems using power converters. 
